...
void OnTick()
  {
   ...
   //+------------------------------------------------------------------+
   //MA indicatoren   
   double H1MA20 = iMA(Symbol(),MAPeriod,20,0,MODE_SMA,PRICE_CLOSE,1);
   double H1MA50 = iMA(Symbol(),MAPeriod,50,0,MODE_SMA,PRICE_CLOSE,1);
   ...
   if(NumberOfTrades()==0){Start=true;}
   else{Start=false;}
   ...
   ObjectSetText("Version", "Version: 2.15", Font, "Arial",MenuColor);
